...
\begin{table}[ht]
	...
	\begin{tabular}{|
		...
		\hline
		&
		\cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}l@{}}$d$\\ $\unitp{mm}$\end{tabular} &
		...
		\cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}l@{}}$\sigma_m$\\ $\unitp{MPa}$\end{tabular} &
		\cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}l@{}}$\sigma_{a}$\\ $\unitp{MPa}$\end{tabular} &
		\cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}l@{}}$\tau_m$\\ $\unitp{MPa}$\end{tabular} &
		\cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}l@{}}$\tau_{a}$\\ $\unitp{MPa}$\end{tabular} \\ \hline
