...
%\textbf{Find $ z_H $} Applying Equation 6.37 \cite{tk1} and 6.35 \cite{tk1}:
...
%\[ v_1=6.37 \unit{m/s} \leq 10 \unit{m/s}\Rightarrow \text{AG} = 8\]
%
...
%
%\[ K_F = K_{F\beta}K_{Fv}K_{F\alpha} = 1.1\times 1.18 \times 1.3 = 1.66\]
...
%\[ Y_\varepsilon= \varepsilon_\alpha^{-1} = 1.61^{-1} = 0.62\]
%
%
%\textbf{Find $ Y_F $} Using the formula $ z_v = z\cos^{-3}(\beta) $ and Table 6.18 \cite{tk1}:\\


%\textbf{Find $ K_F $} The value of $ K_F $ has already been found in the previous section. $ K_F = 1.66 $

%\textbf{Find $ \sigma_F $} The module in Equation 6.43 \cite{tk1} is $ m_n = m_t\cos\beta $. Replacing all the values gives:
%\[
%\begin{array}{l@{{} \leq {}}l}
%\sigma_{F1} = \dfrac{2\times 46423.73 \times 1.66 \times 0.62 \times 0.92 \times 3.69}{48.00 \times 83.57 \times 2 \times\cos9.07^\circ} = 41.09 \unitp{MPa} & 217.57 \unit{MPa}\\ 
%\sigma_{F2} = {41.09 \times 3.60}/{3.66} = 40.17 \unitp{MPa}& 201.65 \unit{MPa}
%\end{array}
%\]
